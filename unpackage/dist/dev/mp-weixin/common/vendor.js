...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__CEAB1BF",
    appName: "appointment-hospital",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const tabBar = {
  color: "#dedede",
  selectedColor: "#2380ff",
  list: [
    {
      text: "首页",
      pagePath: "pages/index/index",
      iconPath: "static/images/tab-index.png",
      selectedIconPath: "static/images/tab-index-current.png"
    },
    {
      text: "预约",
    ...
    },
    {
      ...
      selectedIconPath: "static/images/tab-my-current.png"
    }
  ]
};
const uniIdRouter = {};
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{"address":["127.0.0.1","10.177.35.175"],"servePort":7001,"debugPort":9002,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX/plugins/unicloud/**/*.js"]}'), T = I('[{"provider":"aliyun","spaceName":"appointment-hospital","spaceId":"mp-8a4ccc91-9fc1-4e88-ab29-0e33b77946c5","clientSecret":"dTpDRHouMPWtMRUq63uUaw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__CEAB1BF";
} catch (e2) {
